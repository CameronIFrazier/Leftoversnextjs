  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 bg-indigo-500"
      >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        " h-16 items-end gap-4 rounded-2xl px-4 pb-3 md:flex bg-black", //how to change size
        className,
      )}
    >
      {items.map((item) => (
